"""
Modified and used by Josef Anhede for project use
Date: 2025-06-18
...
Description:
MicroPython driver for the HC-SR04 ultrasonic distance sensor. This script allows
distance measurements in centimeters or millimeters using pulse timing.

Modifications may have been made to support project-specific requirements.
"""
...
class HCSR04:
    ...
    def _send_pulse_and_wait(self):
        ...
        try:
            ...
            if pulse_time < 0:
                MAX_RANGE_IN_CM = const(500) # it's really ~400 but I've read people say they see it working up to ~460  # noqa: F821
