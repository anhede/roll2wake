...
class StoryBeat:
    ...
    def __init__(self, beat_text: str, choices: list[Choice], is_ending: bool = False):
    ...
    def from_dict(cls, data: dict) -> "StoryBeat":
        ...
        return cls(beat_text=data["story_beat"], choices=choices, is_ending=data.get("is_ending", False))
